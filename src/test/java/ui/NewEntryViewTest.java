...
//        dialog.getInputTextBox().setText("Do You Want To Overwrite it?");
...
//        assertTrue(title.backgroundEquals("FFFFFF"));
    ...
    public void testChooseVideoSuccessfull(){
        ...
        assertFalse(previewvideo.isVisible());
...
//        previewvideo.click();
//        
//        assertFalse(pausevideo.isEnabled());
//        assertFalse(stopvideo.isEnabled());
