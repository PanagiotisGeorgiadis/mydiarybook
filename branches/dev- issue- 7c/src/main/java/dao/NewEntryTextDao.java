...
public class NewEntryTextDao {
    ...
    public boolean prepareForCreatingTextFile(String userTitle,String userText)
    {
        ...
        String textDestPath = rootPathMock.getDefaultPath()+userMock.getUsername()+fSeparator+userTitle+fSeparator+"Texts"+fSeparator;
        
        FilesDao textDao = new FilesDao();
        
        return textDao.createTextFile(textDestPath, userText);
